<aside class="sb-sidebar" aria-label="Navegação principal">
    ...
    <nav class="sb-nav">
        ...
        <div class="sb-nav-group" x-data="{ open: {{ request()->routeIs('crm.*') || request()->routeIs('leads.*') ? 'true' : 'false' }} }"
             x-show="matchesMenu('comercial crm leads pipeline oportunidades')">
            <button type="button" class="sb-nav-link sb-nav-parent {{ request()->routeIs('crm.*') || request()->routeIs('leads.*') ? 'active' : '' }}"
            ...
            <div class="sb-nav-children sb-hide-collapsed" x-show="open" x-collapse>
                ...
                <a href="{{ route('leads.index') }}" class="sb-nav-child {{ request()->routeIs('leads.*') ? 'active' : '' }}">Leads</a>
            </div>
        </div>
        ...
        @php
            $futureModules = [
                ...
                ['Financeiro', 'financeiro receitas despesas cobranças', 'M12 1v22M17 5H9.5a3.5 3.5 0 0 0 0 7H14a3.5 3.5 0 0 1 0 7H6'],
